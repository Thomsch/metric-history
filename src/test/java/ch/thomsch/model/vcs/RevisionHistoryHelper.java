...
public class RevisionHistoryHelper {
    ...
    public void prepareData(){
        ...
        firstTag("76322c21acadaac608267f5e00e9af6a1e8a6797 2010-10-28T17:06:14-07:00", "0.1");
        tag("d86f495fb4d907885fe9b4e9ba06532dd0aaabe9 2010-12-12T14:14:45-06:00", "0.2");
        tag("288c470840037fc5cd65ff51cd4b445d6d7643b6 2011-02-21T14:37:42-06:00", "0.3");
        masterTag("5d6650a97d9c0f24526f4aeac2ae494bc601785e 2018-11-18T09:57:46-05:00");
        ...
        commit("76322c21acadaac608267f5e00e9af6a1e8a6797 2010-10-28T17:06:14-07:00", tagList.get(0)); // tag v0.1 commit
        ...
        commit("d86f495fb4d907885fe9b4e9ba06532dd0aaabe9 2010-12-12T14:14:45-06:00", tagList.get(1)); // tag v0.2 commit

        commit("9259e3add43cb442859f3e3c9cbe2286920620e3 2010-12-12T14:14:45-06:00", tagList.get(2));
        ...
        commit("288c470840037fc5cd65ff51cd4b445d6d7643b6 2011-02-21T14:37:42-06:00", tagList.get(2)); // tag v0.3 commit

        commit("4a048cc03f5a851b64d9726098df49b5fa4130c6 2018-07-28T17:19:28-04:00", tagList.get(3));
        ...
        commit("5d6650a97d9c0f24526f4aeac2ae494bc601785e 2018-11-18T09:57:46-05:00", tagList.get(3)); // origin/master
    ...
    public Tag tag(String commitIdIsoDate, String tagName){
        ...
        Tag tag = Tag.intermediateTag(parts[0], time(parts[1]), tagName, previousTag);
        previousTag.setNextTag(tag);
        tagList.add(tag);
        return tag;
    }

    public Tag firstTag(String commitIdIsoDate, String tagName){
        String[] parts= commitIdIsoDate.split(" ");
        Tag tag = Tag.firstTag(parts[0], time(parts[1]), tagName);
        tagList.add(tag);
        return tag;
    }

    public Tag masterTag(String commitIdIsoDate){
        String[] parts= commitIdIsoDate.split(" ");
        Tag previousTag = tagList.get(tagList.size() - 1);
    ...
    public Commit commit(String commitIdIsoDate, Tag tag){
        String[] parts= commitIdIsoDate.split(" ");
        Commit c = Commit.createCommitBeforeTag(parts[0], time(parts[1]), tag);
